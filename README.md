...
blurred, or resized — and that skips 13 of 40 transformer blocks when it doesn't need them.
...
input → DINOv2 ViT-g (frozen, 40 blocks)
         ...
         │       "clean" → output here; the remaining 13 blocks never run
         │
...
002d7df53e3ae55af5.jpg   FAKE     84.7        1.000000  deep     1.000|1.000|1.000
0053097bfa680600.jpg     FAKE      1.3        0.474883  shallow  0.000|0.000|1.000
```
...
Full column list and the confidence formula: [USAGE.md](USAGE.md).
